"""Fine-tune Flagstone8878/Qwen3.5-25B-REAP-A3B-Coding on the full Opus dataset.

Usage:
    modal run modal_qwen35_25b_reap_a3b_coding_opus_train.py
    modal run modal_qwen35_25b_reap_a3b_coding_opus_train.py --epochs 2 --max-seq-length 2048
    modal run modal_qwen35_25b_reap_a3b_coding_opus_train.py --hf-repo-id your-name/qwen35-25b-reap-a3b-coding-opus
"""
...
# Config
# ---------------------------------------------------------------------------
APP_NAME = "qwen35-25b-reap-a3b-coding-opus-sft"
BASE_MODEL = "Flagstone8878/Qwen3.5-25B-REAP-A3B-Coding"
...
hf_cache_volume = modal.Volume.from_name("hf-cache-qwen35-25b-reap-a3b-coding", create_if_missing=True)
outputs_volume = modal.Volume.from_name("qwen35-25b-reap-a3b-coding-outputs", create_if_missing=True)
...
def make_run_name(max_seq_length: int, epochs: float) -> str:
    return f"qwen35-25b-reap-a3b-coding-opus-msl{max_seq_length}-e{str(epochs).replace('.', '_')}"
